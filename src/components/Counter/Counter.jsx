...
const Counter = () => {
    return (
        <div className='text-white flex flex-col items-center justify-center  h-[400px] bg-linear-to-r from-[#632EE3] to-[#9F62F2]'>
            <h1 className='text-4xl font-bold '>Trusted by Millions, Built for You</h1>
            <div className='mt-15 flex justify-between md:flex-row flex-col  md:w-[1200px] mx-auto w-[350px]'>
                <div>
