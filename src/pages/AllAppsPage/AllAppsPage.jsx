    ...
    return (
        <div>
            <div className='mt-15 mb-15 text-center'>
                ...
                <p className='text-gray-500 mb-15'> Explore All Apps on the Market developed by us. We code for Millions</p>
            </div>

            <div className='m-15 flex justify-between'>
                <h1 className='font-bold text-xl mb-4'>({allApps.length})Apps Found</h1>
                {/* <Search /> */}
            ...
            <div className='m-15 p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-base-300'>
                {apps.length > 0 ? apps : <p>No apps found.</p>}
